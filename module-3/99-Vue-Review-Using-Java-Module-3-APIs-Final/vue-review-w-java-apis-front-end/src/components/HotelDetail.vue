...
import  JoshsAndBriansExcellentHotelMethods from '@/services/HotelServices'
...
export default {
    ...
    created() {
        ...
        JoshsAndBriansExcellentHotelMethods.hotelGetterMcHoHotelwad(this.$route.params.id)
