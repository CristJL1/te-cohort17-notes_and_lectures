...
select name, population/surfacearea as population_densisty, lifeexpectancy
from country
...
select name, abs(gnp - gnpold) as absolute_gnp_difference, gnp - gnpold as gnp_differnce
from country
