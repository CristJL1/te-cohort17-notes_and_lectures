...
public class AuctionController {
     ...
     * @Return Auction
     * @Param id
     * @Param updatedAuction
     */

    @RequestMapping(path = "/{id}", method = RequestMethod.PUT)
    public Auction updateAuction (@Valid @PathVariable int id, @Valid @RequestBody Auction updatedAuction) throws AuctionNotFoundException {
        return dao.update(updatedAuction, id);
    }
